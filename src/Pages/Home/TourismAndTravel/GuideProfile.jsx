...
const GuideProfile = () => {
  ...
  const foundGuide = guides?.find((guide) => guide._id === id);
  ...
  return (
    <div>
            ...
            <div className="col-span-4 sm:col-span-3">
              <div className="bg-white shadow rounded-lg p-6">
                <div className="flex flex-col items-center">
                  <img
                    src={foundGuide?.profilePicture}
                    className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0"
                  ></img>
                  <h1 className="text-xl font-bold">{foundGuide?.name}</h1>
                ...
                {foundGuide?.workExperience.map((work) => (
                  <div key={work.id} className="mb-6">
                    <div className="flex justify-between">
                      ...
                      <p>
                        <span className="text-gray-600 mr-2 font-poppins font-semibold">
                          At {work?.company}
                        </span>
      ...
      <div className="container mx-auto my-8 p-4 max-w-2xl">
        ...
        <ul>
          {comments.map((comment, index) => (
            <li
              key={index}
              className="border-b py-2 flex justify-start items-center gap-2"
            >
